...
SELECT "work_area",
    ...
    -- phaeo_flag
    (array_remove(array_agg(phaeo_20um_flag), Null)) [1]::NUMERIC phaeo_20um_flag,
    (array_remove(array_agg(phaeo_3um_flag), Null)) [1]::NUMERIC phaeo_3um_flag,
    (array_remove(array_agg(phaeo_2um_flag), Null)) [1]::NUMERIC phaeo_2um_flag,
    (array_remove(array_agg(phaeo_gf_f_flag), Null)) [1]::NUMERIC phaeo_gf_f_flag,
    (array_remove(array_agg(phaeo_bulk_gf_f_flag), Null)) [1]::NUMERIC phaeo_bulk_gf_f_flag,
    -- chla
    (array_remove(array_agg(chla_20um_flag), Null)) [1]::NUMERIC chla_20um_flag,
    (array_remove(array_agg(chla_3um_flag), Null)) [1]::NUMERIC chla_3um_flag,
    (array_remove(array_agg(chla_2um_flag), Null)) [1]::NUMERIC chla_2um_flag,
    (array_remove(array_agg(chla_gf_f_flag), Null)) [1]::NUMERIC chla_gf_f_flag,
    (array_remove(array_agg(chla_bulk_gf_f_flag), Null)) [1]::NUMERIC chla_bulk_gf_f_flag
