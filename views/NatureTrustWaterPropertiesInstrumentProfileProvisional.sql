DROP TABLE IF EXISTS erddap."NatureTrustWaterPropertiesInstrumentProfileProvisional";

CREATE TABLE erddap."NatureTrustWaterPropertiesInstrumentProfileProvisional" as
SELECT
    *
FROM
