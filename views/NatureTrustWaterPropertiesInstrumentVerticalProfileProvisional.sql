DROP TABLE IF EXISTS erddap."NatureTrustWaterPropertiesInstrumentVerticalProfileProvisional";

CREATE TABLE erddap."NatureTrustWaterPropertiesInstrumentVerticalProfileProvisional" as
SELECT
    *
FROM
