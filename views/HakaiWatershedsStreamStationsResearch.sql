...
SELECT
    ...
    discharge_rate_uql,
    CASE
        WHEN discharge_rate_uql = 4 Then null
        else discharge_rate
    ...
    CASE
        WHEN discharge_volume_uql = 4 Then null
    ...
    turbidity_uql,
    CASE
        WHEN turbidity_uql = 4 Then null
        else turbidity_med
    ...
    turbidity_ntu_uql,
    CASE
        WHEN turbidity_ntu_uql = 4 Then null
