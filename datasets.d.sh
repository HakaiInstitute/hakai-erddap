...
DATASETSD_DIR_IGNORE="${DATASETSD_DIR_IGNORE:-}"
...
DXML=$(echo "<erddapDatasets>$(find ""${DATASETSD_DIR}"" -name '*.xml' -type f -print0 ${DATASETSD_DIR_IGNORE} | sort -z | xargs -0 xmlstarlet edit --omit-decl)</erddapDatasets>")
